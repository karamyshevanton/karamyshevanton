...
# 🛠Навыки и инструменты: 
	...
	•	Инструменты - Confluence, Jira, Miro, Holst, draw.io, Figma, Canva, Adobe Photoshop, Postman, Swagger, PowerPoint, Excel;
...
Hard skills:
* Моделирование процессов: знание нотаций UML, BPMN, визуализация процессов в draw.io, Miro, Holst, PowerPoint
* Работа с данными: базовый SQL, моделирование данных;
* Разработка требований: создание user story, составление функциональных и нефункциональных требований, декомпозиция задач на основе бизнес-целей;
* Программные интерфейсы (тестирование через Postman, описание API в Swagger);
* Архитектура систем (понимание клиент-серверной модели и микросервисной архитекутры, SOAP и REST API).
```

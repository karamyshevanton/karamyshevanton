...
👨‍💻Успешно закончил курс системного аналитика в Яндекс Практикуме
-------------------------------------------------

# О себе:  
* 🧠 Уапешно закончил курс Системного аналитика в Яндекс Практикуме. Прошел подготовительный курс по направлению "Python-разработчик" в школе Хекслет; сертификат от 24 мая 2023 года.
...
Soft skills:
* Умею организовать коммуникацию в команде, во время обучения был старшим студентом во время выполнения проектных работ, на хакатоне был капитаном команды;

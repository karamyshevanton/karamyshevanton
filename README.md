...
# О себе:  
* 🧠 Успешно закончил курс Системного аналитика в Яндекс Практикуме. Прошёл подготовительный курс по направлению "Python-разработчик" в школе Хекслет; сертификат от 24 мая 2023 года.
...
| Karpov.Course - Симулятор SQL | 05.2025 - xx.2025 |
| Stepik - Системный анализ и проектирование | 06.2025 - 06.2025 |
